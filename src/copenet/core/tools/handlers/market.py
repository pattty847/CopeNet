...
from .market_forecasts import DESCRIPTORS as FORECAST_DESCRIPTORS, HANDLERS as FORECAST_HANDLERS  # noqa: E402
from .market_macro import DESCRIPTORS as MACRO_DESCRIPTORS, HANDLERS as MACRO_HANDLERS  # noqa: E402

DESCRIPTORS += FORECAST_DESCRIPTORS + EVIDENCE_DESCRIPTORS + FINANCIAL_DESCRIPTORS + CHART_DESCRIPTORS + MACRO_DESCRIPTORS
HANDLERS.update(FORECAST_HANDLERS)
HANDLERS.update(CHART_HANDLERS)
HANDLERS.update(EVIDENCE_HANDLERS)
HANDLERS.update(FINANCIAL_HANDLERS)
HANDLERS.update(MACRO_HANDLERS)
