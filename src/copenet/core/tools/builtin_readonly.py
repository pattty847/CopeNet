...
ALL_DESCRIPTORS = CONTEXT_DESCRIPTORS + FILE_DESCRIPTORS + GIT_DESCRIPTORS + SHELL_DESCRIPTORS + ARTIFACT_DESCRIPTORS + MEMORY_DESCRIPTORS + WORKSPACE_INTEL_DESCRIPTORS
ALL_HANDLERS = {
    **CONTEXT_HANDLERS,
    **FILE_HANDLERS,
    **GIT_HANDLERS,
