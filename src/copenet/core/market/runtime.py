...
from .edgar import chart_events_from_evidence, fetch_fundamentals
from .models import (
    ChartSeriesPayload,
    ChartSeriesRow,
    CompareResult,
...
class MarketRuntime(DashboardRuntime):
    def __init__(
        self,
    ...
    def cached_bars(
        ...
        *,
        ...
        return chart_history_window(self._cache_bars(symbol, timeframe, None, basis=basis), timeframe) or (
