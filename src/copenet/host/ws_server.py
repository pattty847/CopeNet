                    ...
                    payload={
                        ...
                        "features": {
                            "methods": [
                                ...
                                "nasa.apod",
                                "nasa.apod.list",
                                "permissions.allowlist.list",
                                "permissions.allowlist.add",
                                "permissions.allowlist.remove",
                            ],
                            "events": ["connect.challenge", "chat", "briefing.ready", "memory.changed", "userNotes.changed", "sessions.merge.updated", "pulse.updated", "messaging.updated", "approval.pending", "approval.resolved"],
                        },
                    },
                )
            )
