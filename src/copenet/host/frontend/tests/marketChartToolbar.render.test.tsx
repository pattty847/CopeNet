...
test('chart toolbar groups chart tools and keeps the primary alert action fixed', () => {
  ...
  assert.match(html, /aria-label="Time settings"/);
  assert.match(html, /aria-label="Chart mode"/);
  assert.match(html, /aria-label="Chart overlays"/);
  assert.match(html, /class="market-chart-toolbar__fixed"/);
