...
import { Layers, PanelLeft, SlidersHorizontal } from 'lucide-react';
        ...
        <div className="flex h-full min-h-0 flex-col gap-2">
          <div className="flex items-center gap-2 px-1 pt-1">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl border border-shell-border bg-shell-panel px-3 py-2 text-[12px] font-medium text-shell-text"
            >
            ...
            <div className="ml-auto inline-flex items-center gap-1 rounded-full bg-shell-panel px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-shell-muted">
              <Layers className="h-3 w-3 text-shell-accent" />
              Minimal Console
            </div>
          </div>
