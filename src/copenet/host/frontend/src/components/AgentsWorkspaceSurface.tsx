...
export function AgentsWorkspaceSurface() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      {/* On a phone this 40px bar is gone: the same switch renders in the workspace's own
          title row, which the operator needs anyway. Desktop keeps it, because there it
          also carries the "Fleet is working" hand-off line. */}
      {!isMobile && (
