  ...
  return createPortal(
    <div className="fixed inset-0 z-[70] lg:hidden">
      ...
      >
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-shell-border bg-shell-panel/95 px-4 py-3 backdrop-blur">
        ...
        <div className="min-h-0 flex-1 overflow-auto pb-[calc(env(safe-area-inset-bottom)+0.75rem)]">{children}</div>
      </div>
    </div>,
    document.body,
  );
