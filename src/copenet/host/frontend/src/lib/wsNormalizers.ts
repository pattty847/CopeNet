...
export function normalizeToolExecution(raw: unknown): ToolExecution | null {
  ...
  return {
    ...
    activityTitle: payload.activityTitle ? String(payload.activityTitle) : null,
  ...
  for (const item of raw) {
    ...
    if (kind === 'tool_call') {
      ...
      parts.push({
        ...
        activityTitle: toolCall.activityTitle ? String(toolCall.activityTitle) : payload.activityTitle ? String(payload.activityTitle) : null,
    ...
    if (kind === 'tool_result') {
      ...
      if (members.length > 1) {
        parts.push({
          ...
          members: members.map((m: unknown) => {
            ...
            return {
              ...
              activityTitle: member.activityTitle ? String(member.activityTitle) : null,
        ...
        parts.push({
          ...
          activityTitle: toolExecution.activityTitle ? String(toolExecution.activityTitle) : payload.activityTitle ? String(payload.activityTitle) : null,
