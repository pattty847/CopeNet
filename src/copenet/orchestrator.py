...
from copenet.orchestrator_catalog import (
...
from copenet.orchestrator_runtime import send_chat as send_chat_impl
from copenet.orchestrator_titles import generate_title as generate_title_impl, schedule_title_generation as schedule_title_generation_impl
...
class Orchestrator:
    ...
    def _session_payload(entry) -> dict:
        from copenet.orchestrator_catalog import session_payload
