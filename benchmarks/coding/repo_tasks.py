...
def grade_repo_where_is_it(workdir: Path, ctx: GradeContext) -> list[Check]:
    ...
    return [
        ...
        answer_cites_within(text, "src/copenet/host/rpc_observability.py", span_of(workdir, "src/copenet/host/rpc_observability.py", "def handle_observability_settings_update"), label="cites the handler"),
...
def grade_repo_trace_event(workdir: Path, ctx: GradeContext) -> list[Check]:
    ...
    return [
        ...
        answer_cites_within(text, "src/copenet/providers/base.py", span_of(workdir, "src/copenet/providers/base.py", "def token_usage_event"), label="cites token_usage_event"),
        ...
        answer_cites_within(text, "src/copenet/core/orchestrator/token_usage.py", span_of(workdir, "src/copenet/core/orchestrator/token_usage.py", "def summarize_token_usage"), label="cites summarize_token_usage"),
        search_discipline(analysis),
        no_redundant_reads(analysis),
    ]
...
def grade_repo_broad_question(workdir: Path, ctx: GradeContext) -> list[Check]:
    ...
    return [
        ...
        answer_cites_within(text, "src/copenet/core/sessions/session_store.py", span_of(workdir, "src/copenet/core/sessions/session_store.py", "def assert_session_binding"), label="cites assert_session_binding"),
